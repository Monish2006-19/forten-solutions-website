  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        {/* ── HERO ── */}
        <section className="bg-white w-full px-5 md:px-12 lg:px-24 pt-16 pb-12 grid lg:grid-cols-[1fr_1.2fr] gap-12 items-center">
              <div className="z-10">
        ...
        <section className="py-12 bg-white overflow-hidden">
          <div className="w-full mx-auto px-5 md:px-12 lg:px-24">
